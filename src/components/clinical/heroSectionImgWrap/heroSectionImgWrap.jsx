...
import heroSectionBaseImg from "@/../public/images/clinical/heroSectionBaseImg.webp";
...
export default function HeroSectionImgWrap() {
  ...
  const imgSet = [
    {
      img2: "/images/clinical/heroSectionImgTop1.webp",
    },
    {
      img2: "/images/clinical/heroSectionImgTop2.webp",
    },
    {
      img2: "/images/clinical/heroSectionImgTop3.webp",
    },
  ];
